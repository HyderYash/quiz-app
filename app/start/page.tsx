...
//   return (
//     <>
//       <div className="h-screen flex flex-col bg-gradient-to-b from-slate-900 to-slate-800 overflow-auto">
...
import { useState, useEffect } from "react";
import Link from "next/link";
import { Menu, Play, Coins, X } from "lucide-react";
import * as LucideIcons from "lucide-react";
import { useCoins } from "../providers";
import { cn } from "@/lib/utils";
import NavigationMenu from '../components/NavigationMenu';
...
export default function StartPage() {
  ...
  // Show popup when coins are below threshold
  useEffect(() => {
    console.log(coins)
    if (coins < 100) {
